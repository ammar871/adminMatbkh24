...
class AcceptMealsScreen extends StatefulWidget {


  @override
  State<AcceptMealsScreen> createState() => _AcceptMealsScreenState();
}

class _AcceptMealsScreenState extends State<AcceptMealsScreen> {
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    ...
                    TitleLists(title: "قبول الوجبات الجديدة"),
                    const SizedBox(
                      height: 30,
                    ),
                    ListView.builder(
